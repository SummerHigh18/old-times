...
document.getElementById('wonders-img').addEventListener('contextmenu', (e) => {
    e.preventDefault();
...
//         noteWindow.querySelector('.window-content').innerHTML = "<img id='wonders-img' src='../assets/images/meow.png'>";
